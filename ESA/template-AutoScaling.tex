...
model. 
\bestboot{To extend this idea, we calculated challenge RMSEs for each of the fitted-models' predictions and the corresponding
bootstrap samples of the challenge data. We used these bootstrap sample challenge
RMSEs to calculate 95\% confidence intervals of the challenge RMSE for each model. }
...
\yp{Table~\ref{tab:Bootstrap-intervals-challenge}, it is concluded that
@@analysisSummary@@
