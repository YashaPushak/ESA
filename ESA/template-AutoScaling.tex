...
(support) and later challenged with the @@statistic@@s of the \ramdomizedAlgorithm{per-instance @@perInstanceStatistic@@} running times for $@@challengeSizes@@$.
