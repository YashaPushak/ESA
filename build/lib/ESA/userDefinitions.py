...
def evalModel(x,a,modelName):
    ...
    elif(modelName.lower() in ['linlog2','linlog^2']):
        return linlogsquared(a,x)
    # @TODO: Add your own custom model here. x is a numpy array of instance 
    # sizes and a is a list containing instantiations for your model. 
...
def fitModelLS(x,y,modelName,weights=None,a0=None):
    ...
    if(modelName.lower() in ['poly','poly.','polynomial','exp','exp.','exponential','sqrtexp','sqrtexp.','sqrt-exp','rootexp','rootexp.','root-exp','square-root exponential','root exponential','polylog']):
        ...
        b = w[1]
        a = [a,b] 
    # @TODO: Implement a least-squares regression procedure to fit your model
    # here. See above for examples. Note that
...
# @TODO: Defining your model as a function in this way is optional, but
# helpful.
